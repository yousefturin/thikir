            ...
            <View style={styles.buttonGrid}>
              {sortedItems.map((item, index) => (
                ...
                <View style={styles.iconWrapperTop}>
                  <Svg width={topItemIcons[index].width} height={topItemIcons[index].height} viewBox={topItemIcons[index].viewBox}>
                  ...
                  <View style={styles.nameWrapper}>
                    <Text allowFontScaling={false} style={styles.buttonTextTop}>{item.name}</Text>
                  </View>
                </TouchableOpacity>
              ))}
            </View>
