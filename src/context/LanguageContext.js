...
export function LanguageProvider({ children }) {
    ...
    const appIconImage = require("../../assets/Images/splashScreen.png");
        ...
        return (
            <View style={{ flex: 1, backgroundColor: "#151515", paddingTop: moderateScale(200) }}>
                <View style={{ flex: 1, justifyContent: "flex-start", alignItems: 'center' }}>
                    <Image
                        source={appIconImage}
                        style={{ resizeMode: "cover", width: moderateScale(380), height:moderateScale(380) }}
                    />
                </View>
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <ActivityIndicator size="small" color="#5c5b5b" style={{ width: "100%", height: 20 }} />
                </View>
            </View>
        );
    }
