        ...
        >
          <View>
            {selectedLanguage != "Arabic" ? (
              ...
              <Text style={[styles.rectangleText, { textAlign: "left", fontSize: moderateScale(16), fontFamily: "Montserrat" }]}>
                ...
                {'\n\n'}  <Text style={{ fontSize: moderateScale(13), fontFamily: "Montserrat" }}> - ( Sahih Muslim [4/2062] No: [2676])</Text>
              </Text>
